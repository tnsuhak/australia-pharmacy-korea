...
setp('sydney',bachelor_award_year=fact(4,'sydney-structure'),four_year_exit=fact(True,'sydney-structure'),exit_degree=fact('Bachelor of Pharmacy (Honours)','sydney-structure'),highlights=['5년 통합','4년 BPharm(Hons) Exit','Internship 통합'],editorial='5년 Bachelor of Pharmacy (Honours) + Master of Pharmacy Practice 통합과정입니다. 현재 Course Resolutions는 1~4학년 192cp를 충족하면 Bachelor of Pharmacy (Honours)를 수여할 수 있고, 5학년 48cp가 Master of Pharmacy Practice임을 명시합니다.',review_items=['2027 Mathematics prerequisite 적용 여부','USFP 수학 progression 조건'])
...
route('rmit','rmit-associate','other','RMIT · Associate Degree pathway','rmit-2027-apply',None,None,'Associate 2년 + Bachelor 3년',None,None,'2027 BH102 apply 페이지에 Packaged Pathway가 확인됩니다. 총 5년 경로이며 exact credit/진입학년은 별도 확인합니다.',True)
