...
compact_batch={
 ...
 'griffith-pharmacy':(3,['그리피스 약대 과정 구조','입학방법 3가지','2027 Rank 76','수능 331','고2 → Foundation → 1학년 Diploma (Health Sciences) → 약대 2학년','한국 고2 Rank 7 · 수능 260 · 검정고시 평균 70','IELTS 5.5 · 각 5.0','3월 · 6월 · 10월','1학년 Diploma (Health Sciences) → 약대 2학년','한국 고3 Rank 6 또는 수능 280','2027년 3월 1일 · 6월 27일 · 10월 5일','자동심사 · 20%','50% 경쟁 장학','2027 Rank 76은 확정','A$329.85 / 주부터'])
}
...
compact_batch_2={
 ...
 'latrobe-pharmacy':(2,['La Trobe 약대 과정 구조','Bendigo','2027 Guide 참고 ATAR 75.05','보장 컷이 아니라 지원 참고값','별도 과학 선수과목 없음','Foundation → 약대 1학년','IELTS 6.5 · 각 6.5','Health Innovation','30%','Vice Chancellor','50% · 100%','별도 지원 · 경쟁선발','최소 WAM 80','교내 실습약국 + 임상실습','약 1년 등록 인턴십','A$255 / 주부터']),
...
if not latrobe_direct or '2027 Guide 참고 ATAR 75.05' not in str(latrobe_direct['qualification']['value']) or '별도 과학 선수과목 없음' not in str(latrobe_direct['qualification']['value']) or '보장 컷이 아닌 2027 지원 참고값' not in str(latrobe_direct['qualification'].get('note','')):
 errors.append('latrobe-data: 2027 Guide ATAR 75.05 must remain an indicative reference, not a guaranteed 2027 cutoff')
...
if not qut_direct or 'Selection Rank threshold 76' not in str(qut_direct['qualification']['value']) or 'Offer Guarantee 78' not in str(qut_direct['qualification']['value']) or 'assumed knowledge' not in str(qut_direct['qualification']['value']):
 errors.append('qut-data: threshold 76 / guarantee 78 / assumed knowledge distinction missing')
