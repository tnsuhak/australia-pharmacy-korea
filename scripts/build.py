...
home+='''<section class="section soft" id="entry-routes"><div class="wrap"><div class="section-head beginner-head"><div><span class="eyebrow">3 WAYS TO START</span><h2>고등학생이 호주 약대에 가는<br>대표적인 3가지 방법</h2><p>현재 학력과 영어 준비 정도에 따라 출발점이 달라집니다.</p></div></div><div class="admission-grid"><article class="admission-card"><div class="admission-no">01</div><span class="route-label">FOUNDATION</span><h3>Foundation → 약대 1학년</h3><p class="route-lead">고2 수료 후 Foundation을 거쳐 약대 1학년으로 진학합니다.</p><dl><dt>대표 학력</dt><dd>고2 수료부터 지원 가능</dd><dt>영어</dt><dd>IELTS 5.0~5.5+부터</dd><dt>진학</dt><dd>Foundation 수료 → 약대 1학년</dd></dl><a href="/foundation/">Foundation 자세히 보기 →</a></article><article class="admission-card"><div class="admission-no">02</div><span class="route-label">DIPLOMA / IYO</span><h3>Diploma → 약대 2학년</h3><p class="route-lead">고3 졸업·검정고시 후 Diploma를 마치고 약대로 진학합니다.</p><dl><dt>대표 학력</dt><dd>고3 졸업 또는 검정고시</dd><dt>영어</dt><dd>IELTS 6.5 전후</dd><dt>진학</dt><dd>Griffith·Curtin → 약대 2학년</dd></dl><p class="route-exception">Adelaide: 학점 인정 학생 → 7월 입학 심사</p><a href="/diploma/">Diploma 자세히 보기 →</a></article><article class="admission-card"><div class="admission-no">03</div><span class="route-label">DIRECT ENTRY</span><h3>Direct → 약대 1학년</h3><p class="route-lead">수능·IB·A-level·SAT·OSSD로 약대 1학년에 바로 지원합니다.</p><dl><dt>대표 성적</dt><dd>수능 300점대부터 대학별 차이 큼</dd><dt>영어</dt><dd>IELTS 대체로 6.5~7.0</dd><dt>추가조건</dt><dd>수학·화학 등 선수과목 대학별 상이</dd></dl><a href="/admission-requirements/">Direct 조건 보기 →</a></article></div><p class="representative-note">대학마다 요구 점수·선수과목·영어가 다릅니다. 정확한 기준은 대학별 페이지에 정리했습니다.</p><div class="graduate-note"><div><span class="eyebrow">ALREADY HAVE A DEGREE?</span><h3>이미 대학을 졸업했다면 Graduate Entry도 있습니다</h3><p>학사학위가 있다면 Monash Graduate Entry 같은 대졸자 전형을 따로 볼 수 있습니다.</p></div><a class="btn secondary" href="/compare/?qualification=graduate">Graduate Entry 보기 →</a></div></div></section>'''

home+='<section class="section finder-section"><div class="wrap"><div class="section-head"><div><span class="eyebrow">NOW FIND YOUR OPTIONS</span><h2>이제 내 조건으로 호주약대를 찾아보세요</h2><p>학력·화학·입학시기를 고르면 지원할 대학을 바로 좁혀드립니다.</p></div><a href="/compare/">상세필터로 전체 비교 →</a></div>'+finder(True)+'''<div class="quick-chips profile-chips"><span>내 상황 바로가기</span><a href="/foundation/">고2 수료 · Foundation</a><a href="/compare/?qualification=korean_high_school">고3 졸업 · Direct/Diploma</a><a href="/compare/?qualification=ged">검정고시 · 가능한 약대</a><a href="/admission-requirements/">수능·IB·A-level·OSSD</a></div></div></section>'''

home+='<section class="section soft"><div class="wrap"><div class="section-head"><div><span class="eyebrow">START WITH THESE OPTIONS</span><h2>구조가 다른 주요 약대부터 비교해 보세요</h2><p>3년 Fast-track, 4년 Bachelor+PharmD, 5년 통합형과 다양한 입학방법을 함께 봅니다.</p></div><a href="/compare/">'+str(len(U))+'개 대학 전체 보기 →</a></div><div class="card-grid">'+''.join(card(prog) for i in ['uwa','jcu','monash','uq','griffith','sydney'] for prog in D['programs'] if prog['university_id']==i and prog['id']!='uq-pharmd')+'</div></div></section>'
