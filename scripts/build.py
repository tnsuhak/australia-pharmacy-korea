...
ROUTE={'direct':'Direct','foundation':'Foundation','diploma':'Diploma / IYO','graduate':'Graduate Entry','other':'Other Pathway'}
PREREQ={'required':'필수','recommended':'권장','not_required':'필수 아님','accepted':'인정','assumed':'Assumed knowledge'}
...
def finder(home=False):
    first=select('qualification','학력 / 시험',[('','선택해 주세요')]+list(QUAL.items())[:-2]+[('graduate','대학 졸업'),('other','기타 국제학교')])
    ...
    advanced=select('route','입학경로',[('','전체 경로')]+list(ROUTE.items()))
...
home='''<section class="hero"><div class="wrap hero-grid"><div><span class="eyebrow">2027 AUSTRALIA PHARMACY GUIDE</span><h1>호주 약대,<br><em>나에게 맞는</em><br>입학경로부터.</h1><p class="hero-copy">수능·IB·SAT·내신부터 Foundation·Diploma까지.<br>내 학력과 선수과목으로 시작할 수 있는<br>호주 약대의 경로를 비교해 보세요.</p><div class="button-row"><a class="btn" href="#finder">내 조건으로 찾기 <span>↗</span></a><a class="btn text" href="/compare/">전체 약대 비교 →</a></div><div class="hero-meta"><span>15개 대학 검토</span><span>4가지 주요 입학경로</span><span>2027 정보 구분 제공</span></div></div><div class="route-illustration"><div class="top"><h2>같은 목표, 다른 출발점</h2><span class="live-dot">PATHWAY GUIDE</span></div><div class="path-visual"><span class="n">01</span><div><h3>Direct Entry</h3><p>학력·성적·선수과목 충족</p></div><span class="end">본과 1학년</span></div><div class="path-visual"><span class="n">02</span><div><h3>Foundation</h3><p>기초과목 준비 + 진급조건 충족</p></div><span class="end">본과 1학년</span></div><div class="path-visual"><span class="n">03</span><div><h3>Diploma / IYO</h3><p>공식 연계과정 + 학점인정</p></div><span class="end">학년 단축 검토</span></div><div class="path-visual"><span class="n">04</span><div><h3>Graduate Entry</h3><p>관련 학사 + 대학 과목 심사</p></div><span class="end">별도 진입</span></div></div></div></section><div class="wrap">'''+finder(True)+'''<div class="quick-chips"><span>많이 찾는 조건</span><a href="/compare/?chemistry=no">화학을 안 배웠어요</a><a href="/compare/?intake=7">7월에 시작하고 싶어요</a><a href="/diploma/">Diploma 학점인정</a><a href="/compare/?route=graduate">대학을 졸업했어요</a></div></div>'''
home+='''<section class="section"><div class="wrap"><div class="section-head"><div><span class="eyebrow">UNDERSTAND THE DIFFERENCE</span><h2>3년·4년·5년, 기간만 보면 안 됩니다</h2><p>학위 기간과 약사 등록까지 필요한 과정이 학교마다 다릅니다.</p></div><a href="/pharmacist-registration/">등록과정 이해하기 →</a></div><div class="process-grid"><div class="process-card"><span class="number">3<small>년</small></span><h3>빠른 학사 과정</h3><p>JCU·UTas는 3년 Fast-track.<br>졸업 후 등록 인턴십은 별도입니다.</p><a href="/3-year-pharmacy/">빠른 과정 살펴보기 →</a></div><div class="process-card"><span class="number">4<small>년</small></span><h3>일반적인 4년 약대</h3><p>대부분 4년 학사 후 약사 등록을 위한 인턴십이 별도로 이어집니다.</p><a href="/compare/?duration=4">4년 과정 비교 →</a></div><div class="process-card"><span class="number">5<small>년</small></span><h3>5년 통합형도 서로 다릅니다</h3><p>Monash·Sydney의 통합 실무과정과 UNSW의 졸업 후 등록 구조는 다릅니다.</p><a href="/compare/?duration=5">5년 과정 비교 →</a></div></div></div></section>'''
home+='<section class="section soft"><div class="wrap"><div class="section-head"><div><span class="eyebrow">START WITH THESE OPTIONS</span><h2>경로별로 살펴보는 주요 약대</h2><p>빠른 학사, 통합과정, 한국 Diploma까지 비교해 보세요.</p></div><a href="/compare/">15개 대학 전체 보기 →</a></div><div class="card-grid">'+''.join(card(prog) for i in ['jcu','monash','uq','griffith','sydney','utas'] for prog in D['programs'] if prog['university_id']==i and prog['id']!='uq-pharmd')+'</div></div></section>'
home+='''<section class="section"><div class="wrap split-panel"><div><span class="eyebrow">FIND YOUR ROUTE</span><h2>성적표 하나로<br>경로를 단정하지 않습니다</h2><div class="route-list"><a class="route-row" href="/admission-requirements/"><b>01</b><div><h3>Direct · 본과 1학년</h3><p>수능·IB·SAT 등 Pharmacy 전용 기준 비교</p></div><span class="arrow">↗</span></a><a class="route-row" href="/foundation/"><b>02</b><div><h3>Foundation · 대학 진학 준비</h3><p>선수과목과 영어, 본과 진급조건까지</p></div><span class="arrow">↗</span></a><a class="route-row" href="/diploma/"><b>03</b><div><h3>Diploma · 학점인정 경로</h3><p>Griffith·Curtin의 연결 과정과 남은 기간</p></div><span class="arrow">↗</span></a></div></div><div class="feature-panel"><span class="eyebrow">KOREA → GRIFFITH</span><h2>한국에서 시작하는<br>Griffith 약대 경로</h2><p>UniCentre South Korea Diploma에 대한<br>2027 입학부터의 공식 학점인정 협약을 확인했습니다.</p><div class="metric">80<small>CP 인정</small></div><p>본과 잔여 240CP · T1 시작 3년 / T2 시작 3.5년<br><small>입학·영어조건 충족 및 최종 심사 필요</small></p><a class="btn" href="/diploma/griffith-korea/">한국 Diploma 경로 보기 →</a></div></div></section>'''
...
register('/','2027 호주 약대 비교 · 내 조건에 맞는 입학경로 | TNS','한국 학생을 위한 2027 호주 약대 전문 가이드. Direct, Foundation, Diploma, Graduate Entry 경로와 선수과목·학비·약사등록 구조를 비교하세요.',home)

comp=pagehero('2027 호주 약대 비교','입학경로·선수과목·시작 시기를 함께 살펴보세요. 15개 대학의 16개 과정 중 확인된 조건과 추가 확인이 필요한 항목을 나눠 보여드립니다.','전체 약대 비교')
comp+='<div class="compare-sticky"><a href="#finder">조건 수정 ↑</a><span>최대 3개 과정 비교</span></div><section class="section"><div class="wrap">'+finder()+'''<div class="results-head"><div><h2>검토할 과정 <span class="results-count" id="result-count">16</span></h2><p id="result-summary" role="status" aria-live="polite">조건을 선택하면 확인 상태를 구분합니다.</p></div><p class="view-note">‘조건 일치’는 선택한 항목에만 해당합니다.<br>전체 입학자격·합격·비자 발급을 판정하지 않습니다.</p></div><div class="empty" id="empty-results" hidden><h3>확인된 조건에 맞는 과정이 없습니다</h3><p>조건을 줄이거나 아래 ‘추가 확인 필요’ 과정을 살펴보세요.</p><button type="button" id="reset-empty">필터 초기화</button></div><div class="card-grid" id="match-results">'''+''.join(card(p) for p in D['programs'])+'''</div><h2 class="pending-heading" id="pending-heading" hidden>추가 확인 필요 <span id="pending-count"></span></h2><p class="small" id="pending-note" hidden>미공개·자료 차이·경로별 세부 조건이 남아 있습니다. 불합격 또는 지원 불가를 뜻하지 않습니다.</p><div class="card-grid" id="pending-results"></div>'''+callout('대학원 전용 UWA·CDU·UTS는 이 학부 비교에서 제외했습니다. La Trobe의 2027 국제학생 모집 등 확인 중인 과정은 ‘비교 후보’로 구분합니다.')+'</div></section>'
register('/compare/','2027 호주 약대 비교 · 입학경로·화학·입학시기 필터 | TNS','호주 약대 15개 대학, 16개 과정을 조건별로 비교합니다. 3년·4년·5년, 화학, 7월 입학, Foundation·Diploma·Graduate Entry를 구분합니다.',comp)
...
admit_items=[('read','입학조건은 네 가지를 따로 확인합니다','<div class="process-grid">'+''.join(f'<div class="process-card"><span class="number">{n}</span><h3>{t}</h3><p>{d}</p></div>' for n,t,d in [('1','학력과 성적','대학 최소 기준이 아닌 Pharmacy 전용 환산점수를 확인합니다.'),('2','선수과목','수학·화학·생물·물리의 과목명, 수준, 최소 성적을 대조합니다.'),('3','영어와 입학시기','약대 전용 영어의 각 영역과 해당 학기의 국제학생 모집을 확인합니다.')])+'</div>'+callout('SAT·IB·A-level이 있다고 모든 약대에 같은 점수로 지원할 수 있는 것은 아닙니다. 선수과목이나 영어조건이 점수와 별도로 적용됩니다.')),
 ('qualifications','한국 학생의 학력별 출발점',table([('수능','대학별 표준점수 합산 방식과 Pharmacy 환산 기준 확인'),('IB / A-level / SAT','학력 인정·시험 성적과 별도로 수학·과학 과목 수준 확인'),('OSSD','평균 산정 과목 수·Grade 12 과목·Pharmacy cut-off 확인'),('한국 내신 / 검정고시','대학별 인정 여부를 확인하고 Foundation·Diploma 입학자격도 함께 검토'),('대학 졸업','이전 전공·졸업연도·대학 성적·이수과목에 따라 Graduate Entry 검토')],responsive=True)),
...
dip_items=[('credit','Diploma는 인정학점과 남은 기간을 봅니다','<p>과정 이름에 Health Sciences가 있어도 약대 2학년으로 연결된다고 단정할 수 없습니다. 공식 articulation에 적힌 대상 학위, 지정 과목, 인정학점, 진급 성적을 확인하세요. IYO도 해당 약대 연결이 검증된 경우에만 같은 범주에서 비교합니다.</p>'),('routes','확인된 연결과 별도 검토 경로',routecards(dip)),('griffith','Griffith · 세 경로 비교',table([('Direct','본과 1학년','고교/시험·선수과목·영어조건 충족'),('Griffith College Diploma','80CP 인정','본과 잔여 T1 3년 / T2 3.5년'),('한국 UniCentre Diploma','80CP 인정 · 2027 입학부터','한국과정 1년 + 본과 잔여 T1 3년 / T2 3.5년')],['경로','학점·진입','주의할 조건'],True)+link('/diploma/griffith-korea/','한국 UniCentre 경로 자세히 →','btn text')),('curtin','Curtin · 학점 외에 추가 조건','<p>현재 Curtin College 메인 과정 페이지는 Stage 2 CWA 70%를 안내합니다. 175 credits와 12월 PHAR1002 추가 이수를 함께 충족해야 합니다. 구 course information의 65%를 새 기준처럼 사용하지 않습니다.</p>'),('questions','자주 묻는 질문',faq([('Diploma를 마치면 무조건 2학년으로 가나요?','아닙니다. 대학 입학조건과 Diploma 진급 성적, 지정 과목, 영어조건을 충족하고 최종 학점인정을 받아야 합니다.'),('80CP는 항상 본과 3년을 뜻하나요?','Griffith의 해당 협약은 T1 시작 시 3년, T2 시작 시 3.5년을 안내합니다. 시작학기에 따라 남은 일정이 달라집니다.')])+sources(source_ids(dip)))]
register('/diploma/','호주 약대 디플로마 · Griffith·Curtin 학점인정 | TNS','Griffith College, 한국 UniCentre, Curtin College Pharmacy Diploma를 비교합니다. 학점인정, 진급 성적, 추가 과목과 남은 학업기간을 구분합니다.',pagehero('Diploma로 연결하는 호주 약대','‘2학년 진학’이라는 한 문장보다, 인정되는 학점과 실제 남은 기간이 중요합니다.','Diploma / IYO')+article(dip_items))
kroute=next(r for r in dip if r['id']=='unicentre-korea')
kitems=[('route','한국에서 1년, 본과에서 남은 학점 이수','<p>Griffith 공식 학점인정 기록은 UniCentre South Korea의 1년 Diploma of Health Science 수료자 중 Bachelor of Pharmacy (Honours)에 입학한 학생에게 80CP를 인정합니다. 적용 시점은 2027 entry onwards입니다.</p><div class="route-mini"><span>한국 UniCentre 1년</span>→<span>입학조건·영어 충족</span>→<span>80CP 학점인정</span>→<span>Griffith 본과 잔여 240CP</span></div>'),('time','본과 시작학기에 따른 기간',table([('Trimester 1','본과 3년','한국 1년 + 본과 3년'),('Trimester 2','본과 3.5년','한국 1년 + 본과 3.5년')],['본과 시작','공식 잔여 기간','단순 학업기간 합계'],True)+callout('위 합계는 두 과정 사이의 대기기간, 휴학, 재수강을 제외한 일정 비교입니다. 약사등록 준비기간은 별도입니다.')),('conditions','무엇이 확인됐고 무엇이 남았나요?',routecards([kroute])+callout('한국 과정 개강월·학비·입학성적, Griffith 진급 GPA·영어 세부 조건은 추가 확인 중입니다. 장학은 Diploma 자체가 아니라 본과 입학·학점인정 후 별도 심사합니다.',True)),('compare','호주 College와 함께 비교','<p>Griffith College의 2026/2027 Diploma도 2027 본과부터 80CP 협약이 있습니다. 한국에서 준비할지, 호주에서 대학 적응을 시작할지는 언어·생활·총비용·일정까지 비교해 결정합니다.</p>'+link('/diploma/','세 경로 비교로 돌아가기 →','btn text')+sources(['griffith-korea','griffith-college','griffith-scholarship']))]
register('/diploma/griffith-korea/','한국 UniCentre → Griffith 약대 · 2027 80CP 경로 | TNS','2027부터 적용되는 UniCentre South Korea Diploma의 Griffith 약대 80CP 공식 학점인정, 남은 기간, 확인할 입학·영어조건을 정리합니다.',pagehero('한국 Diploma → Griffith 약대','UniCentre South Korea 공식 articulation을 기준으로, 학점인정과 실제 입학조건을 나눠 살펴봅니다.','한국 UniCentre 경로')+article(kitems))
