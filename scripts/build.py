...
directory_body+='<section class="section"><div class="wrap"><div class="university-directory-intro"><div><strong>3년</strong><span>JCU · UTas</span></div><div><strong>3.5~3.75년</strong><span>UQ 7월 · Curtin</span></div><div><strong>4년</strong><span>일반 BPharm + UWA 특수구조</span></div><div><strong>5년</strong><span>Monash · Sydney · UNSW · UQ 신설</span></div></div><div class="pharmacy-school-grid">'+''.join(directory_card(u) for u in D['universities'])+'</div><div class="secondary-tool"><span>성적·화학·입학월로 대학을 좁혀보세요.</span><a href="/compare/">내 조건으로 찾기 →</a></div></div></section>'
