...
home+='''<section class="section"><div class="wrap"><div class="section-head"><div><span class="eyebrow">UNDERSTAND THE DIFFERENCE</span><h2>몇 년인가보다, 무엇이 포함되는가</h2><p>학위기간과 약사등록까지의 준비기간은 다를 수 있습니다.</p></div><a href="/pharmacist-registration/">등록과정 이해하기 →</a></div><div class="process-grid"><div class="process-card"><span class="number">3<small>년</small></span><h3>압축된 학사 과정</h3><p>JCU·UTas의 Fast-track.<br>학위 후 등록 인턴십은 별도입니다.</p><a href="/3-year-pharmacy/">빠른 과정 살펴보기 →</a></div><div class="process-card"><span class="number">4<small>년</small></span><h3>학사와 등록 준비를 나눠서</h3><p>학사 과정의 실습과 등록용 supervised practice를 구분하세요.</p><a href="/compare/?duration=4">4년 과정 비교 →</a></div><div class="process-card"><span class="number">5<small>년</small></span><h3>통합학위마다 다른 구조</h3><p>Monash·Sydney의 통합 실무과정과 UNSW 졸업 후 인턴십은 다릅니다.</p><a href="/compare/?duration=5">5년 과정 비교 →</a></div></div></div></section>'''
