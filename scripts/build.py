...
home+='<section class="section soft"><div class="wrap"><div class="section-head"><div><span class="eyebrow">START WITH THESE OPTIONS</span><h2>경로별로 살펴보는 주요 약대</h2><p>빠른 학사, 통합과정, 다양한 입학경로를 비교해 보세요.</p></div><a href="/compare/">15개 대학 전체 보기 →</a></div><div class="card-grid">'+''.join(card(prog) for i in ['jcu','monash','uq','griffith','sydney','utas'] for prog in D['programs'] if prog['university_id']==i and prog['id']!='uq-pharmd')+'</div></div></section>'
home+='''<section class="section"><div class="wrap split-panel"><div><span class="eyebrow">FIND YOUR ROUTE</span><h2>성적표 하나로<br>경로를 단정하지 않습니다</h2><div class="route-list"><a class="route-row" href="/admission-requirements/"><b>01</b><div><h3>Direct · 본과 1학년</h3><p>수능·IB·SAT 등 Pharmacy 전용 기준 비교</p></div><span class="arrow">↗</span></a><a class="route-row" href="/foundation/"><b>02</b><div><h3>Foundation · 대학 진학 준비</h3><p>선수과목과 영어, 본과 진급조건까지</p></div><span class="arrow">↗</span></a><a class="route-row" href="/diploma/"><b>03</b><div><h3>Diploma · 학점인정 경로</h3><p>Griffith·Curtin의 연결 과정과 남은 기간</p></div><span class="arrow">↗</span></a></div></div><div class="feature-panel"><span class="eyebrow">FAST FOUNDATION → UQ</span><h2>2월 Foundation에서<br>7월 UQ 약대로</h2><p>UQ College Accelerated Foundation은<br>약 4개월 일정으로 7월 본과 연결을 검토할 수 있습니다.</p><div class="metric">4<small>개월 Foundation</small></div><p>2027년 2월 시작 → 7월 완료 → UQ 약대 7월 입학<br><small>Foundation 진급성적·선수과목·최종 심사 충족 필요</small></p><a class="btn" href="/foundation/">UQ Foundation 경로 보기 →</a></div></div></section>'''
...
register('/diploma/','호주 약대 디플로마 · Griffith·Curtin 학점인정 | TNS','Griffith College와 Curtin College Pharmacy Diploma의 학점인정, 진급 성적, 추가 과목과 남은 학업기간을 비교합니다.',pagehero('Diploma로 연결하는 호주 약대','‘2학년 진학’이라는 한 문장보다, 인정되는 학점과 실제 남은 기간이 중요합니다.','Diploma / IYO')+article(dip_items))
